...
namespace CM.Services.AssignmentProcessApi.Migrations
{
    ...
    [Migration("20220228131811_update3")]
            ...
            modelBuilder.Entity("CM.Services.AssignmentProcessApi.Models.AssignmentProcess", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AssignmentProcessId = new Guid("7efe74c1-42c0-489d-970f-78c8abb0d002"),
                            Action = "",
                            Brocker = "Nikita",
                            Consultant = "NV",
                            Customer = "Volvo",
                            ...
                            Length = 0,
                            StartDate = new DateTime(2022, 5, 28, 14, 18, 11, 615, DateTimeKind.Local).AddTicks(5710),
                            Status = "Submitted",
                            Title = "BackEnd"
                        });
                });
